            ...
            <div class="details-header">
              <div class="header-title">
                ...
                <div class="composition-summary">
                  ...
                  <span class="summary-total">总成本 ¥{{ calculateTotalCost(scope.row.finished).toFixed(2) }}</span>
                  <span v-if="scope.row.selling_price" class="summary-price">售价 ¥{{ scope.row.selling_price.toFixed(2) }}</span>
                  <span v-if="scope.row.selling_price" class="summary-profit">利润率 {{ calculateProfitRate(scope.row, scope.row.finished) }}%</span>
                </div>
              </div>
            </div>
...
.composition-summary span.summary-total {
  background: rgba(255, 215, 0, 0.95);
  color: #5d4e37;
}

.composition-summary span.summary-price {
  background: rgba(34, 197, 94, 0.95);
  color: white;
}

.composition-summary span.summary-profit {
