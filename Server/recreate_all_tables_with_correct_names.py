...
# 删除所有相关表（按依赖顺序）
tables = ['finishedproductaccessory', 'finishedproductbead', 'finishedproduct', 'accessory', 'bead', 'product', 'finished_product_accessory', 'finished_product_bead', 'finished_product']
...
# 创建finished_product_accessory表（带下划线）
...
print("\nAll tables recreated successfully with correct names.")
